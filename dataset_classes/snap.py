...
from dataset_classes.twitch_gamers import load_twitch_gamer_dataset
...
class SNAPDataset(InMemoryDataset):
    ...
    available_datasets = {
        ...
        'twitch_gamers': ['twitch_gamers.zip'],
    }
    ...
    def process(self) -> None:
        ...
        elif self.name == 'twitch_gamers':
            data_list = load_twitch_gamer_dataset(raw_dir=self.raw_dir)
        else:
